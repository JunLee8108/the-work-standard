        ...
        {hasSubItems ? (
          <>
            <button
              ...
              className="w-full cursor-pointer flex items-center justify-between px-4 py-2.5 text-sm font-medium rounded-lg transition-colors text-gray-700 hover:bg-gray-100"
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 py-4 border-t border-gray-200">
            <button
              onClick={signOut}
              className="cursor-pointer w-full flex items-center px-4 py-2.5 text-sm font-medium text-red-600 rounded-lg hover:bg-red-50 transition-colors"
            >
